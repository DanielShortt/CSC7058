    ...
    var environmentArray = {'time':'', 'setting':'','lighting':'','atmosphere':'','mainProp':'','propLoc':'','camera':'', 'numberChars':'' };

    const characterArray = {'gender1':'', 'hair1': '', 'pose1': '', 'top1': '', 'bottoms1': '', 'prop1': '', 
    ...
    function loadJSON(){
        ...
        .then(data => {
            ...
            var count2 = environmentArray.length;
            var countLoop = 0;
            ...
            //console.log(data.Environment[0][0]);

            environmentArrayTitles
            ...
            // for (property in data.Environment[0]) {
            //     //data.Environment[0][property] = environmentArray[count]
            //     console.log(data.Environment[0][property]);
            //     countLoop+=1;
            // }
